...
- [x] **Stores data in MongoDB** - I put user info, posts, and boards all in mongodb.
- [x] **Stores credentials in MongoDB** - User information is stored in mongo to make it more persistent.

## 🚀 WebSocket deliverable

For this deliverable I did the following. I checked the box `[x]` and added a description for things I completed.

- [x] **Backend listens for WebSocket connection** - Backend listens for users to connect to notify them.
